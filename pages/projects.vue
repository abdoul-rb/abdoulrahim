            ...
            <div class="mt-10 sm:mt-20">
                ...
                <ul class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                    <li v-for="(project, index) in projects" :key="index"
                        class="rounded-lg group relative bg-[#1C2738] p-6 focus-within:ring-2 focus-within:ring-inset cursor-pointer">
                        <div class="flex justify-between items-center">
                            <span>
                                <svg class="h-10 w-10 text-sky-700" xmlns="http://www.w3.org/2000/svg" fill="none"
                            ...
                            <div class="flex items-center space-x-4">
                                <a :href="project.github" class="text-gray-300 group-hover:text-gray-400"
                                    aria-hidden="true">
                        ...
                        <div class="mt-6">
                            <h3
                                class="text-lg font-semibold leading-6 text-white tracking-wide group-hover:text-[#0084C7] transition duration-100">
                        ...
                        <div class="mt-6 flex items-center gap-2 text-sm font-light text-slate-600 flex-wrap">
                            <strong v-for="(stack, i) in project.stacks" :key="i">
                                {{ stack }}
                            </strong>
                        </div>
